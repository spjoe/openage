...
GameRenderer::GameRenderer(openage::Engine *e)
	...
	std::string equalsEpsilon_code = util::read_whole_file(data_dir->join("shaders/equalsEpsilon.glsl"));
	...
	shader::Shader teamcolor_frag{GL_FRAGMENT_SHADER, {shader_header_code, ("#define NUM_OF_PLAYER_COLORS " + ss.str() + "\n").c_str(), equalsEpsilon_code, teamcolor_frag_code.c_str()}};
